...
from helpers import to_gpu, Corpus, batchify
...
with open('{}/vocab_idx2word.json'.format(args.outf), 'w') as f:
    json.dump(corpus.dictionary.idx2word, f)
...
def save_model():
    ...
    with open('{}/classifer_model.pt'.format(args.outf), 'wb') as f:
